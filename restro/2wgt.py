...
def display_menu():
    ...
    subprocess.Popen(["python", r"C:\Users\tannu\OneDrive\Desktop\restro\3delmenu.py"])  # Open menu.py using subprocess
...
# Load JSON data
with open(r"C:\Users\tannu\OneDrive\Desktop\restro\assets\normal_chat.json",
...
def display_image():
    # Load the image
    image = Image.open(
        r"C:\Users\tannu\OneDrive\Desktop\restro\assets\botimg.jpg")  # Replace "path/to/your/image.jpg" with the actual path to your image file
